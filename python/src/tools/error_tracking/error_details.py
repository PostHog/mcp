...
from src.schema.errors import ErrorDetails


async def error_details_handler(context: Context, params: ErrorDetails) -> ToolResult:
...
def error_details_tool() -> Tool[ErrorDetails]:
    return Tool(
        name="error-details",
