...
from src.schema.errors import ListErrors


async def list_errors_handler(context: Context, params: ListErrors) -> ToolResult:
...
def list_errors_tool() -> Tool[ListErrors]:
    return Tool(
        name="list-errors",
