...
export const InsightQuerySchema = z.object({
	insightId: z.number(),
	dateFrom: z.string().optional().describe("Start date for the query (e.g., '2024-01-01', '-7d', '-1dStart')"),
	dateTo: z.string().optional().describe("End date for the query (e.g., '2024-01-31', '-1d', '-0d')"),
